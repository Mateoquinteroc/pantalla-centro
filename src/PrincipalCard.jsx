...
const PrincipalCard = () => {
    return ( 
        <div>
           ...
           <p className=" absolute top-5 left-1/2 transform -translate-x-1/2   4xl:text-8xl text-xl text-white font-medium font-open-sans text-center align-top mix-blend-lighten">Conoce la programación <br/> que tenemos para ti</p>
           <div className="absolute top-0 right-0 w-auto h-auto mt-10 font-open-sans">
            <p className="pr-3  m-5 4xl:text-6xl text-xl text-white font-black  font-open-sans">Del 25 al 29</p> 
           ...
           <div className="absolute top-0 right-0 w-full h-[15vh]  p-10 mt-0 bg-red-500/60 mix-blend-color-burn"></div>
        </div>
