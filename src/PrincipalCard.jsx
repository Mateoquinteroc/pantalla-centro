...
const PrincipalCard = () => {
    return ( 
        ...
        <div className="absolute top-0 right-0 w-full h-[15vh]  p-10 mt-0 bg-rojo/80 mix-blend-darken 3xl:h-[12vh] "></div>
           ...
           <p className=" absolute top-5 left-1/2 transform -translate-x-1/2   4xl:text-6xl text-xl text-white font-bold font-open-sans text-center align-top mix-blend-lighten 3xl:text-4xl">Conoce la programación <br/> que tenemos para ti</p>
           <div className="absolute top-0 right-0 w-auto h-auto mt-10 font-open-sans 3xl:mt-2">
            <p className=" 4xl:text-4xl text-xl text-white font-black  font-open-sans  m-5 pr-2 3xl:m-1 3xl:w-fit">Del 19 al 23</p> 
            ...
            <p className="pl-[50%] m-5 4xl:text-5xl text-xl text-white font-normal font-open-sans 3xl:m-0 4xl:mt-[4vh] 4xl:pl-[60%] ">2024</p> 
           </div>
