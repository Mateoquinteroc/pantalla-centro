...
const PrincipalCard = () => {
    return ( 
        ...
        <div className="absolute top-0 right-0 w-full h-[15vh]  p-10 mt-0 bg-rojo/80 mix-blend-darken 3xl:h-[12vh] "></div>
           ...
           <div className="absolute top-0 right-0 w-auto h-auto mt-10 font-open-sans 3xl:mt-5">
            <p className=" 4xl:text-6xl text-xl text-white font-black  font-open-sans  m-5 pr-2 3xl:w-fit">Del 25 al 29</p> 
