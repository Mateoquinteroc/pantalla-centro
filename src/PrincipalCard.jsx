    ...
    return ( 
        ...
        <div className="absolute top-0 right-0 w-full h-[15vh]  p-10 mt-0 bg-rojo/80 mix-blend-darken 3xl:h-[12vh] "></div>
           ...
           <div className="absolute top-0 right-0 w-auto h-auto mt-10 3xl:mt-2 font-open-sans ">
            <p className=" 4xl:text-5xl text-xl text-white font-black  font-open-sans 3xl:m-0 3xl:mr-[1vw] 3xl:w-fit 4xl:mr-[2vh] justify-self-end">Del 26 al 1</p> 
            <p className=" 4xl:text-5xl text-xl text-white font-normal font-open-sans 3xl:m-0 4xl:absolute 4xl:pl-[1.5vh] 3xl:pl-[1vh] justify-self-end">de marzo </p> 
            <p className=" 4xl:text-5xl text-xl text-white font-normal font-open-sans  4xl:mt-[3vh] 4xl:pl-[50%] 3xl:pl-[40%] justify-self-end">2024</p> 
           </div>
