...
const Recorrido3d = (child) => {
    ...
    return (
        <aside className={` ${Context.isCardBaseDetailsOpen ? 'flex' : 'hidden' } fixed top-1/2 left-1/2 transform -translate-x-1/2 4xl:-translate-x-1/2 4xl:-translate-y-1/2 -translate-y-[55%] mt-10 bg-slate-50 w-[80vw] h-[70vh] rounded-3xl z-10 overflow-x-hiddenn`}>
            <XMarkIcon className='absolute right-0 h-5 w-5 3xl:w-7 3xl:m-2 text-black-500 m-4 4xl:h-10 4xl:w-10'
