...
const FooterCard = () => {
    ...
    return (
        <div className="absolute bottom-0  w-full gap-x-[500px] ">
            ...
            <button className="absolute m-0 w-fit h-fit 4xl:h-[100px] 3xl:h-[80px] 4xl:w-[400px] left-10 4xl:bottom-[2vh] 3xl:bottom-4 bg-blue-500 hover:bg-blue-700 text-white text-4xl font-bold py-2 px-4 rounded-full z-10 font-open-sans " onClick={() => {Context.openQr()}}>ChatBOT</button>
