...
const FooterCard = () => {
    ...
    return (
        <div className="absolute bottom-0 right-0 w-full gap-x-[500px] ">
            <button className={`absolute h-[100px] w-[300px] bottom-[3vh] left-10 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full z-10`} onClick={() => {Context.openCardBaseDetails()}}>boton </button>
