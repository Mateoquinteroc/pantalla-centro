...
const BotAI = () => {
    ...
    return (
        <aside className={` ${Context.isQrOpen ? 'flex' : 'hidden' } fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 3xl:-translate-y-[55%] mt-10 bg-slate-50 w-[80vw] h-[70vh] rounded-3xl z-10 overflow-x-hidden`}>
